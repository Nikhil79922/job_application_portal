            ...
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem
                  ...
                  className="cursor-pointer rounded-xl px-3 py-3 text-sm font-medium text-red-500 transition-all duration-300 focus:bg-red-50 focus:text-red-600 dark:focus:bg-red-500/10"
                >
