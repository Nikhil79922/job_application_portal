// src/features/jobs/components/update-job-form.tsx
...
export default function UpdateJobForm({
  ...
  const onSubmit:
    SubmitHandler<UpdateJobFormValues> =
      (values) => {
      ...
      >
        ...
        <div className="pt-2">
          ...
          >
            ...
            immediately on the live listing
          </p>
        </div>
      </form>
    </div>
