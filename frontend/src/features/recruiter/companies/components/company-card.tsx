                ...
                {menuOpen && (
                  ...
                  >
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-slate-700 transition-all hover:bg-slate-100 hover:text-slate-950 dark:text-zinc-300 dark:hover:bg-white/[0.06] dark:hover:text-white"
                    >
                    ...
                    <button
                      ...
                      className="mt-1 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-red-500 transition-all hover:bg-red-50 disabled:pointer-events-none disabled:opacity-60 dark:hover:bg-red-500/10"
                    >
