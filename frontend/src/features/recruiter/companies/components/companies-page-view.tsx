  ...
  <div className="relative z-10 mx-auto max-w-7xl px-5 py-8 lg:px-8">
        ...
        <div className="flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white/70 p-4 transition-transform duration-300 dark:border-white/10 dark:bg-white/[0.03]">
          ...
          <div className="flex flex-col gap-4 xl:w-[340px]">
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white/70 p-5 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <Button
                ...
                className="mt-5 h-12 w-full rounded-2xl bg-emerald-500 text-sm font-semibold text-white shadow-lg shadow-emerald-500/20 transition-colors duration-300 hover:bg-emerald-600"
              >
...

    {
      showCreate && (
        ...
        <div className="mt-8 overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-lg dark:border-white/10 dark:bg-[#111111]">
    ...
    {/* FIXED */}
    <div className="mt-8 rounded-[28px] border border-slate-200 bg-white/80 p-4 shadow-lg backdrop-blur-sm dark:border-white/10 dark:bg-[#111111]/80">
        ...
        <div className="flex flex-1 flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50/80 pl-11 pr-4 text-sm font-medium text-slate-900 outline-none transition-colors duration-300 placeholder:text-slate-400 focus:border-emerald-400 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 dark:border-white/10 dark:bg-white/[0.03] dark:text-white dark:placeholder:text-zinc-500 dark:focus:bg-white/[0.05]"
            />
          </div>

          <button className="flex h-12 items-center gap-2 rounded-2xl border border-slate-200 bg-slate-50/80 px-4 text-sm font-semibold text-slate-700 transition-colors duration-300 hover:bg-slate-100 dark:border-white/10 dark:bg-white/[0.03] dark:text-zinc-300 dark:hover:bg-white/[0.05]">
