    ...
    <div className="group flex flex-col gap-1.5">
...

      {
        error && (
          ...
          <p className="animate-[fadeSlideUp_0.2s_ease_both] flex items-center gap-1.5 text-[11px] font-semibold text-red-500">
                ...
                <Field
                  ...
                  hint={
                    ...
                    "recruiter"
                      ...
                      ? "Introduce your company culture and hiring vision"

                      : "A short professional summary visible to recruiters"
                  }
                >
                    ...
                    <textarea
                      ...
                      placeholder={
                        ...
                        "recruiter"
                          ...
                          ? "We're building a fast-growing engineering team focused on scalable systems and exceptional products..."
...

              {
                isPending && (
                  ...
                  <div className="absolute inset-0 overflow-hidden">
                    ...
                    <div className="animate-[shimmer_1.2s_linear_infinite] absolute inset-y-0 w-24 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
                  </div>
                )
              }
