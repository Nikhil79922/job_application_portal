...
// Services
import { authRegister } from "../../domain/services/auth/myProfile.service.js";
...
export const authRegisterService = new authRegister(userRepo, refreshRepo, passwordService, tokenService, fileUpload);
